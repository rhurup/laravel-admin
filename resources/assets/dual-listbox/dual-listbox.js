            ...
            /***/ (function (module, __webpack_exports__, __webpack_require__) {
                ...
                var DualListbox = function () {
                    ...
                    _createClass(DualListbox, [{
                        ...
                        key: "addEventListener", value: function addEventListener(eventName, callback) {
                            this.dualListbox.addEventListener(eventName, callback);
                        }
                    }, {
                        key: "addSelected", value: function addSelected(listItem) {
                            var _this = this;
                        ...
                        key: "removeSelected", value: function removeSelected(listItem) {
                            var _this2 = this;
                        ...
                        key: "searchLists", value: function searchLists(searchString, dualListbox) {
                        ...
                        key: "updateAvailableListbox", value: function updateAvailableListbox() {
                            this._updateListbox(this.availableList, this.available);
                        }
                    }, {
                        key: "updateSelectedListbox", value: function updateSelectedListbox() {
                            this._updateListbox(this.selectedList, this.selected);
                        }
                    }, {
                        key: "_actionAllSelected", value: function _actionAllSelected(event) {
                            var _this3 = this;
                        ...
                        key: "_updateListbox", value: function _updateListbox(list, elements) {
                        ...
                        key: "_actionItemSelected", value: function _actionItemSelected(event) {
                            event.preventDefault();
                        ...
                        key: "_actionAllDeselected", value: function _actionAllDeselected(event) {
                            var _this4 = this;
                            event.preventDefault();
                        ...
                        key: "_actionItemDeselected", value: function _actionItemDeselected(event) {
                            event.preventDefault();
                            var selected = this.dualListbox.querySelector(".".concat(SELECTED_MODIFIER));
                            if (selected) {
                        ...
                        key: "_actionItemDoubleClick", value: function _actionItemDoubleClick(listItem) {
                        ...
                        key: "_actionItemClick", value: function _actionItemClick(listItem, dualListbox) {
                        ...
                        key: "_addActions", value: function _addActions() {
                            this._addButtonActions();
                            this._addSearchActions();
                        }
                    }, {
                        key: "_addButtonActions", value: function _addButtonActions() {
                            var _this5 = this;
                        ...
                        key: "_addClickActions", value: function _addClickActions(listItem) {
                            var _this6 = this;
                        ...
                        key: "_addSearchActions", value: function _addSearchActions() {
                            var _this7 = this;
                        ...
                        key: "_buildDualListbox", value: function _buildDualListbox(container) {
                        ...
                        key: "_createList", value: function _createList(search, header, list) {
                        ...
                        key: "_createButtons", value: function _createButtons() {
                        ...
                        key: "_createListItem", value: function _createListItem(option) {
                        ...
                        key: "_createSearchLeft", value: function _createSearchLeft() {
                        ...
                        key: "_createSearchRight", value: function _createSearchRight() {
                        ...
                        key: "_deselectOption", value: function _deselectOption(value) {
                        ...
                        key: "_initOptions", value: function _initOptions(options) {
                        ...
                        key: "_initReusableElements", value: function _initReusableElements() {
                        ...
                        key: "_selectOption", value: function _selectOption(value) {
                            var options = this.select.options;
                            for (var i = 0; i < options.length; i++) {
                                var option = options[i];
                                if (option.value === value) {
                        ...
                        key: "_splitOptions", value: function _splitOptions(options) {
                            for (var i = 0; i < options.length; i++) {
                                var option = options[i];
                        ...
                        key: "isDomElement", value: function isDomElement(o) {
                ...
                __webpack_exports__["default"] = (DualListbox);
