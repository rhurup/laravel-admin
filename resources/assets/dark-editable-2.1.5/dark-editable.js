...
import {Popover as f} from 'https://cdn.jsdelivr.net/npm/bootstrap@5.3.6/+esm';
import l from "https://cdn.jsdelivr.net/npm/moment@2.30.1/+esm";
...
class g extends p {
  ...
  initOptions() {
    const t = this.context.get_opt("format", "YYYY-MM-DD HH:mm"),
        e = this.context.get_opt("viewformat", "YYYY-MM-DD HH:mm");
