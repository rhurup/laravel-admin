<span class="grid-selector" data-bs-toggle="modal" data-bs-target="#{{ $modal }}" id="{{ $display_field }}-{{$key}}"
      key="{{ $key }}" data-display_field="{{ $display_field }}" data-val="{{ $original }}">
            ...
            <div class="modal-content" style="border-radius: 5px;">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-light"
                            data-bs-dismiss="modal">{{ admin_trans('admin.cancel') }}</button>
