...
class MultipleFile extends Field
{
     ...
     */
    protected static $js = [
        '/vendor/laravel-admin/bootstrap-fileinput/js/fileinput.min.js' => 'application/javascript',
        '/vendor/laravel-admin/bootstrap-fileinput/js/plugins/sortable.min.js' => 'application/javascript',
    ];
